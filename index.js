...
const main = async () => {
    ...
    const b = new Date('2022-05-05T08:30:00Z').toISOString()
    const d = new Date('2022-07-05T08:30:00Z').toISOString()
    const [rev, revStatus] = await client.getMerchantReviews({ merchantId: merchants[0].id, dateFrom: b, dateTo: d, pageSize: 100 })
